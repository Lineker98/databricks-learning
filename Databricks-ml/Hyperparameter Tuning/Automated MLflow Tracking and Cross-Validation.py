...
evaluator = MulticlassClassificationEvaluator(label="indexedLabel", metricName="weightedPrecision")
...
with mlflow.start_run():
    mlflow.spark.log_model(spark_model=model, artifact_path="best_model")
