...
# MAGIC
# MAGIC 1. Hyperopt: A library for ML hyperparameter tuning in Python
# MAGIC 2. Apache Spark MLlib: A library of distributed algorithms for training ML models (also called as "Spark ML")
# MAGIC
...
# MAGIC
# MAGIC For more information about the Hyperopt APIs, see the Hyperopt documentation.
...
# MAGIC This example tunes two hyperparameters: minInstancesPerNode and maxBins. See the Hyperopt documentation for details on defining a search space and parameter expressions.
